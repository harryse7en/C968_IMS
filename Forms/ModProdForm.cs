...
namespace IMS
{
    public partial class ModProdForm : Form
    {
        ...
        // ---------- Form Constructor ----------
        public ModProdForm(Product prod)
        {
            InitializeComponent();
            textID.Text = prod.ProductID.ToString();
            textName.Text = prod.Name;
            textInventory.Text = prod.InStock.ToString();
            textPrice.Text = prod.Price.ToString();
            textMax.Text = prod.Max.ToString();
            textMin.Text = prod.Min.ToString();
            assocParts = prod.AssociatedParts;
            ...
            dgPartsAssoc.DataSource = prod.AssociatedParts;
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            Inventory.updateProduct(Int32.Parse(textID.Text), _prod);
